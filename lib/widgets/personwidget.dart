...
user person = user();
  ...
  void initState() {
    ...
    connectApi().getData(url: USER, query: data,token: token).then((value) async {
      print(value);
      setState(() {
            ...
            children: [
              InkWell(
                // splashColor: Colors.transparent,
                  ...
                  ClipOval(
                    child:
                    widget._Image == null?    Image.asset(Accounts[0].Photo,width: 120,height: 120,fit: BoxFit.cover,):
                    Image.file(
                      widget._Image!,
                      width: 160,
                      height: 160,
...
color: Colors.red,),
      ...
      child: GridView(
        ...
        children:/* Restaurants.asMap().entries.map((RestaurantData){
          ...
          return RestaurantItem(Name: RestaurantData.Name,
            rate: RestaurantData.rate,
            ImageLogo: RestaurantData.ImageLogo,
            personreviews: RestaurantData.personreviews, restaurantdescription: RestaurantData.restaurantdescription, Branches: RestaurantData.branches,);
        }).toList(),
