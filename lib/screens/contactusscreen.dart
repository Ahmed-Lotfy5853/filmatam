...
class _ContactusScreenState extends State<ContactusScreen> {
  ...
  Widget build(BuildContext context) {
              ...
              children: [
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: CustomizedTextFormField(Keyboard: TextInputType.multiline, Controller: MessageController, Hint: 'الرساله',min: 4,max:true, PIcon: Icons.message,Validation: (value) {
                            if (value!.isEmpty) {
                ...
                Container(
                    ...
                    child: FloatingActionButton(onPressed: (){
                        if (ContacusValidationKey.currentState!
                            .validate()) {
    ...
    MessageStr = MessageController.text;
                        ...
                        ,elevation: 10,backgroundColor: CustomColor.MainColor,child: Image.asset('assets/icons/telegram.png',scale: 0.6,))),
              ],
            )
          ],
        ),
